...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex bg-landingPageLight text-black dark:bg-landingPage dark:text-white">
      {/* --- BACK BUTTON --- */}
      <div className="absolute top-4 left-4">
        ...
        >
          {backing && (
            <div className="appearArrowAnimatiuon p-0 m-0">
              <IoIosArrowRoundBack size={"40px"} className="backIconAnimation" />
            </div>
          )}
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-sm">
          <div className="mb-6 text-center">
            ...
            <p className={`text-sm mt-2 ${registerError ? 'visible' : 'invisible'} text-red-500 dark:text-error`}>
              {registerError || '\u00A0'}
            </p>
          </div>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            <div>
              ...
              <div className="mt-2">
                <input 
                  id="firstname" name="firstname" type="text" autoComplete='off' required 
                  onChange={(e) => setFirstName(e.target.value)}
                  className="block w-full rounded-md border-0 py-2 px-3 shadow-sm ring-1 ring-inset focus:outline-none focus:ring-1 sm:text-sm bg-white text-black ring-slate-300 focus:ring-violet-300 dark:bg-slate-800 dark:text-white dark:ring-slate-600 dark:focus:ring-purple-400
                  appearance-none"
                />
              </div>
            </div>
            <div>
              ...
              <div className="mt-2">
                <input 
                  id="lastname" name="lastname" type="text" autoComplete='off' required 
            ...
            <div>
              ...
              <div className="mt-2 relative">
                <input
                  ...
                  required
                  autoComplete='off'
                  className="block w-full rounded-md border-0 py-2 px-3 pr-10 shadow-sm ring-1 ring-inset focus:outline-none focus:ring-1 sm:text-sm bg-white text-black ring-slate-300 focus:ring-violet-300 dark:bg-slate-800 dark:text-white dark:ring-slate-600 dark:focus:ring-purple-400
                  appearance-none"
                />
            ...
            <div className="flex flex-col items-center space-y-4 pt-2">
              ...
              <p className="text-sm text-slate-600 dark:text-white">
                ...
                <a href='./login' className="font-semibold ml-1 text-violet-600 hover:text-violet-500 dark:text-indigo-300 dark:hover:text-indigo-200">
                  Log In
                </a>
              </p>
            </div>
      ...
      <div className="flex-1 bg-white border hidden border-zinc-50 md:flex md:justify-center md:items-center h-screen">
        <div className="text-center">
          ...
          <p className="shadowFrame">
            <svg version="1.1" className="shadow" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="61px" y="20px"
